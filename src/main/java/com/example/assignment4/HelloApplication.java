...
public class HelloApplication extends Application {
    ...
    private Rectangle createCloud7(Scene scene) {
        ...
        String icon= getClass().getResource("/point.png").toExternalForm();
    ...
    public void GameOver(){
        ImageView lose =new ImageView(getClass().getResource("/over.png").toExternalForm());
        lose.setLayoutX(40);
        lose.setLayoutY(10);
        lose.setFitWidth(720);
        lose.setFitHeight(600);
    ...
    private Rectangle createPlane(Scene scene) {
        ...
        String icon= getClass().getResource("/airplane.png").toExternalForm();
        Image patter=new Image(icon);
        image.setY(130);
        image.setX(130);
